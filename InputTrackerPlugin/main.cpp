...
char kMimeType[] = "application/x-inputtracker-plugin";
...
nsPluginInstanceBase* NS_NewPluginInstance(
  ...
  nsPluginInstanceInputTracker* plugin = 
    new nsPluginInstanceInputTracker(aCreateDataStruct->instance);
...
void NS_DestroyPluginInstance(nsPluginInstanceBase * aPlugin) {
  if(aPlugin) {
    delete (nsPluginInstanceInputTracker*)aPlugin;
  }
}
